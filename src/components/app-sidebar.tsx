...
import { Clock3, CalendarDays, LayoutDashboard, Timer } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const items = [
  ...
  { title: "Meetings Hub", url: "/meetings", icon: CalendarDays, admin: false },
  { title: "Admin Dashboard", url: "/admin", icon: LayoutDashboard, admin: true },
];
        ...
        <div className="flex min-w-0 items-center gap-2.5 rounded-xl bg-sidebar-accent px-2.5 py-2">
          ...
          <div className="min-w-0 group-data-[collapsible=icon]:hidden">
            ...
            <p className="truncate text-xs text-sidebar-foreground/60">
              {currentUser.role} · {teamName(currentUser.teamId)}
            </p>
          </div>
        </div>
      </SidebarFooter>
