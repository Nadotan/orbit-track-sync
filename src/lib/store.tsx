  ...
  const value: AppStore =
    {
      ...
      startSession: () => {
        ...
        /*
         * Save the running clock on
         * the server so the reminder
         * works after the PWA closes.
         */
        void setClockStatus({
          data: {
            startedAt:
          ...
          (error) => {
            console.error(
              "Could not save remote clock state:",
              error,
            );
          },
        );
      ...
      cancelSession: () => {
        ...
        /*
         * Cancellation also means
         * there is no active clock
         * to remind about.
         */
        void setClockStatus({
          data: {
          ...
          (error) => {
            console.error(
              "Could not clear remote clock state:",
              error,
            );
          },
        );
      ...
      stopSession: (
        ...
        void (async () => {
          ...
          /*
           * Always clear the remote
           * clock because the user
           * explicitly pressed Stop.
           */
          try {
            await setClockStatus({
              data: {
                startedAt:
                  null,
              },
      ...
      createMeeting: (
        ...
        void (async () => {
           ...
           * Real Web Push:
           *
           * This server call sends to
           * subscribed users even if
           * their Chrona app is closed.
           */
          try {
            await broadcastNewMeetingPush({
              data: {
                title:
                  meeting.title,
            ...
            /*
             * Meeting creation should
             * remain successful even
             * if push delivery fails.
             */
            console.error(
              "Meeting created, but phone notification failed:",
              error,
            );
          }
